...
model = load_model("D:\GitHub\TENG\ML_Model\mrained_model_our.keras") # Load the trained model

names = ["dushan left leg","dushan right leg"]
            ...
            if client.is_connected:
                ...
                while True: # Read the value of the preconfigured characteristic
                    ...
                    if not(np.array_equal(previous_voltages, voltages)) and len(voltages)==data_count:
                        ...
                        # print(voltages)
                        array = voltages[np.newaxis, ..., np.newaxis]
